...
1. 從 [GitHub Releases](https://github.com/yaotong110329/taipei-elearn-assistant/releases) 下載 `TaipeiELearnAssistant-v1.0.0-win64.zip`。
...
2. 可用「管理常用關鍵字」調整清單。預設包含環境教育、性別平等、人權教育、轉型正義、資通安全、ODF、職場霸凌、人工智慧、廉政與服務倫理、行政中立、多元族群文化及公民參與。
3. 按「搜尋全部關鍵字」。程式會跨分頁搜尋，每個關鍵字最多取 5 門。
...
5. 複製 AI 回答，按「從剪貼簿讀取並繼續」。格式及選項驗證通過後，程式會自動填入、送出，再進入下一門測驗。
